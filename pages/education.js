    ...
    <div className={styles.educationDiv}> 
        ...
        <div className={styles.splitDiv}>
            <article className={styles.overviewDiv}>
                ...
                <p>In Advanced Programming we expanded from the Programming in the previous year while still using Java. One of our assignments was to create a scheduler which is shown in the projects. Another assignment was to create an android app within a day which would map the locations of train stations. </p>
                ...
                <p>In this unit, the first half consisted of learning how to configure the different components in a network such a routers, switches, and machines. The second half of this unit was studying operating systems learning how to do bash scripting in Linux and understanding the different file system structures.</p>
    ...
    <div className={styles.educationDiv}>
        ...
        <div className={styles.splitDiv}>
                <article className={styles.overviewDiv}>
                    ...
                    <p>Throughout this unit we studied React-Native to help us build a mobile app which would interact with a back end API that was already created. We also learnt industry practices such as version control, testing and Lintrs and were encouraged to use these throughout the project.</p>
